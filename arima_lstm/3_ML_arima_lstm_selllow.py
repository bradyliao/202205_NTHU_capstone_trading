...
if __name__ == '__main__':
    ...
    data = pd.read_csv('YOUR-DATA-HERE.csv', index_col=0, header=0).reset_index(drop=True)
    ...
    for ma in optimized_period:
        ...
        mse = mean_squared_error(final_prediction.values, data['close'].tail(test_len).values)
        rmse = mse ** 0.5
